...
$webclient.Credentials = $credentials 
    ...
    #eg func call: upload-SPFile 'C:\testSP.txt' 'http://our.healthbc.org/sites/TelehealthLMC/administration/Reports/!--Monthly%20Reports--!/Issuetrak/2019' $AutomationAcctDir $AutomationCredDir
...
$CredUserDir = "\\vch.ca\home$\HomeDir02\WHu\Profile\Desktop\iSchedulerAutomation\PScredential\iScheduler_rpt_username.securestring"
$CredpswdDir = "\\vch.ca\home$\HomeDir02\WHu\Profile\Desktop\iSchedulerAutomation\PScredential\iScheduler_rpt_pw.securestring"
# for uploading to sharepoint and email to users
$AutomationAcctDir = "\\vch.ca\home$\HomeDir02\WHu\Profile\Desktop\iSchedulerAutomation\PScredential\AutomationAccount.securestring"
$AutomationCredDir = "\\vch.ca\home$\HomeDir02\WHu\Profile\Desktop\iSchedulerAutomation\PScredential\AutomationCred.securestring"
...
#FOLDER SETUP
 ...
 #Script Location
 Set-Location \\vch.ca\home$\HomeDir02\WHu\Profile\Desktop\iSchedulerAutomation\PScall
...
$MasterFilepath = 'C:\PS_outputs\TEST\' #'C:\PS_outputs\' WHU
...
{   
    ...
    switch -regex ($folder)
         {   
           'APP'  { $uploadDestination  = 'http://our.healthbc.org/sites/TelehealthLMC/administration/Reports/!--Monthly%20Reports--!/LoginReview/'; break}
           #'CRY'  { $uploadDestination  = '############################################################################################CRY destination'; break}
           #'CVC'  { $uploadDestination  = '############################################################################################CVC destination'; break}
           'DMT'  { $uploadDestination  = 'http://our.healthbc.org/sites/TelehealthLMC/administration/Reports/!--Monthly%20Reports--!/Issuetrak/'  ; break}
         }
...
#*******************************************************************************#
    ...
    $recipients = @($recipients)   #("william.hu@vch.ca", "jenny.chan@vch.ca")
